var quiz = [
  {
    ...
    q3: [],
    option: [
      `Incisional scars will contract over time as the children grow longitudinally.`,
  ...
  },
  {
    ...
    q3: [],
    option: [
      `Bradycardia may be seen upon insufflation.`,
  ...
  },
  {
    ...
    q3: [],
    option: [
      `Increase in end-tidal CO<sub>2</sub>`,
  ...
  },
  {
    ...
    q3: [],
    option: [
      `Polymorphonuclear cells and macrophages, as well as levels of interleukin-6 (IL-6), are increased locally due to the effect of pneumoperitoneum across the entire abdominal wall, as compared with open surgery.`,
  ...
  },
  {
    ...
    q3: [],
    option: [
      `A fascial hernia is rarely identified.`,
  ...
  },
  {
    ...
    q3: [],
    option: [
      `an increased risk of visceral injury with open access.`,
  ...
  },
  {
    ...
    q3: [],
    option: [
      `have not been reported in trocar sites smaller than 5 mm`,
  ...
  },
  {
    ...
    q3: [],
    option: [
      `may be prevented by using CO<sub>2</sub> insufflation.`,
  ...
  },
  {
    ...
    q3: [],
    option: [
      `training standardization across centers.`,
