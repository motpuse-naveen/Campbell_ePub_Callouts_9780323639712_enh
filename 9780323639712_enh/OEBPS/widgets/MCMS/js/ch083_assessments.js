var quiz = [
  ...
  },
  {
    ...
    q3: [],
    option: [
      `it has a higher sterilization rate than standard vasectomy with incision.`,
...

  {
    ...
    q3: [],
    option: [
      `Hematoma is the least frequent complication.`,
...

  {
    ...
    q3: [],
    option: [
      `there was a palpable epididymal abnormality.`,
...

  {
    ...
    q3: [],
    option: [
      `As in children, surgical repair is never indicated.`,
...

  {
    ...
    q3: [],
    option: [
      `decrease the length of symptoms.`,
...

  {
    ...
    q3: [],
    option: [
      `A genetic defect links seminal vesicle agenesis to renal agenesis.`,
...

  {
    ...
    q3: [],
    option: [
      `The perineal route because this has the quickest recovery.`,
...

  {
    ...
    q3: [],
    option: [
      `Need for exploration of the ipsilateral kidney`,
