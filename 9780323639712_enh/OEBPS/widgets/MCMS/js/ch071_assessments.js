var quiz = [
        ...
        type: `MCSS`},
    {
        ...
        q2: ``,
        q3: [],
        option: [` The ejaculatory process comprises three phases: emission, ejection, and orgasm.`, 
        ...
        type: `MCSS`},
    {
        ...
        type: `MCSS`},
      {
        ...
        q2: ``,
        q3: [],
        option: [`The <i>Diagnostic and Statistical Manual of Mental Disorders</i> (DSM-V) definition of premature ejaculation (PE) is an operationalized multivariate definition that captures the key dimensions of latency, control, and bother. `, 
        ...
        type: `MCSS`},
    {
        ...
        q2: ``,
        q3: [],
        option: [`The International Society for Sexual Medicine (ISSM) developed the first contemporary, evidence-based definition of lifelong and acquired PE. `, 
        ...
        type: `MCSS`},
     {
        ...
        q2: ``,
        q3: [],
        option: [`Men with acquired PE tend to have lower IELT than men with lifelong PE `, 
	...
	type: `MCSS`        ,
        type: `MCSS`},
     {
        ...
        q2: ``,
        q3: [],
        option: [` There is a substantial disparity between the incidence of PE in epidemiological studies that rely upon either patient self-report of PE and/or inconsistent and poorly validated definitions of PE.`, 
        ...
        type: `MCSS`},
    {
        ...
        q2: ``,
        q3: [],
        option: [` Intentionally “rushing” intercourse to prevent early detumescence of a partial erection is common`, 
        ...
        type: `MCSS`},
    {
        ...
        q2: ``,
        q3: [],
        option: [`A physical examination is mandatory in an effort to identify the etiology of the PE `, 
	...
	type: `MCSS`        ,
        type: `MCSS`},
     {
        ...
        q2: ``,
        q3: [],
        option: [`All men seeking treatment for PE should receive basic psychosexual education or coaching. `, 
        ...
        type: `MCSS`},
    {
        ...
        q2: ``,
        q3: [],
        option: [`Dapoxetine is a rapid-acting and short half-life SSRI taken 1 to 3 hours before sexual contact. `, 
        ...
        type: `MCSS`},
    {
        ...
        q2: ``,
        q3: [],
        option: [`The DSM-IV-TR definition of delayed ejaculation is evidence-based on a small number of community-based IELT studies. `, 
        ...
        type: `MCSS`},
    {
        ...
        q2: ``,
        q3: [],
        option: [` The ability to ejaculate increases with descending levels of spinal injury`, 
        ...
        type: `MCSS`},
    {
        ...
        q2: ``,
        q3: [],
        option: [`Retrograde ejaculation can be confirmed by the presence of spermatozoa in post-masturbation first-void urine. `, 
